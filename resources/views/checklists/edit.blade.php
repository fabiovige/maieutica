                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input disabled class="form-control" type="text" name="name"
                                        value="{{ $checklist->kid->name }}" readonly>
                                </div>
                                <div class="col">
                                    <label for="birth_date">Data de nascimento</label> <br>
                                    <input disabled class="form-control " type="text" name="birth_date"
                                        value="{{ $checklist->kid->birth_date }}" readonly>
                                </div>
                                <div class="col">
                                    <label for="created_at">Data de criação</label> <br>
                                    <input disabled class="form-control bg-ligth" type="text" name="created_at"
                                        value="{{ $checklist->created_at->format('d/m/Y') }}" readonly>
                                </div>
                                <div class="col">
