...
<li class="breadcrumb-item active" aria-current="page">
    <i class="bi bi-person-vcard"></i> Plano Automático
</li>
@endsection
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div title="Visualizar Competências"
                            class="card mt-2 {{ ($status->note === 0 ? 'bg-secondary' :
                ...
                <div class="table-responsive mt-4" id="competencesTable" style="display: none;">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            ...
                            <a id="generatePlanBtn"
                                href="{{ route('kids.pdfplaneauto', ['id' => $kid->id, 'checklistId' => $checklist->id, 'note' => $status->note]) }}"
