    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-6">
                ...
                <form id="pdfForm"
                    action="{{ route('kids.generatePdf', ['kidId' => $kid->id, 'levelId' => $levelId]) }}" method="POST"
        ...
        <ul class="nav nav-tabs" id="chartTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="bar-tab" data-bs-toggle="tab" data-bs-target="#bar-chart"
                    type="button" role="tab" aria-controls="bar-chart" aria-selected="true">Gráfico de Barras</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="radar-tab" data-bs-toggle="tab" data-bs-target="#radar-chart" type="button"
                    role="tab" aria-controls="radar-chart" aria-selected="false">Gráfico Radar</button>
            </li>
            <li class="nav-item" role="presentation">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="geral-tab" data-bs-toggle="tab" data-bs-target="#geral-chart" type="button"
                    role="tab" aria-controls="geral-chart" aria-selected="false">Análise Geral</button>
            </li>
        </ul>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="progress" role="progressbar" aria-label="{{ $domain['name'] }}"
                                                ...
                                                aria-valuemax="100">
                                                <div class="progress-bar" style="width: {{$domain['percentage']}}%">
                                                </div>
                                            </div>
