                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control"
                               value="{{ $medicalRecord->creator->name ?? 'N/D' }}@if($medicalRecord->creator && $medicalRecord->creator->professional && $medicalRecord->creator->professional->first()) - {{ $medicalRecord->creator->professional->first()->council_label }}: {{ $medicalRecord->creator->professional->first()->registration_number }}@endif"
                               readonly>
                    </div>
