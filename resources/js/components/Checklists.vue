            ...
            <table class="table table-sm table-striped mt-2">
              <tbody>
                <tr v-for="component in data.competences[domain]" :key="component.id">
                  <td class="customColumnCode">{{ level_id }}{{ domain }}{{ component.code }}</td>
                  <td>
                    <a
